...
CREATE TABLE IF NOT EXISTS `p39_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='分类' AUTO_INCREMENT=31 ;
...
(3, '小米note', '3000.00', '2000.00', '<p>小米好用</p>', '是', '否', '2016-11-16 10:39:43', 'Goods/2016-11-16/582bc6ef54c8b.jpg', 'Goods/2016-11-16/thumb_3_582bc6ef54c8b.jpg', 'Goods/2016-11-16/thumb_2_582bc6ef54c8b.jpg', 'Goods/2016-11-16/thumb_1_582bc6ef54c8b.jpg', 'Goods/2016-11-16/thumb_0_582bc6ef54c8b.jpg', 3, 2, 0, '80.00', '2017-01-10 00:00:00', '2017-01-30 00:00:00', '否', '否', '是', 95, '否'),
(4, '三星冰箱', '2000.00', '1800.00', '', '是', '否', '2016-11-17 11:15:22', '', '', '', '', '', 1, 17, 0, '0.00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '否', '否', '否', 100, '是'),
...
(6, '测试测试测试', '3000.00', '2800.00', '', '是', '否', '2016-12-05 10:06:48', '', '', '', '', '', 0, 0, 1, '99.00', '2017-01-13 16:52:00', '2017-01-15 16:52:00', '否', '是', '是', 100, '否');
