							...
							<li class="product">
								<dl>
									...
									<?php foreach($v as $k1 => $v1):?>
										<a <?php if($k1==0) echo 'class="selected"' ;?>  href="javascript:;"><?php echo $v1['attr_value'];?> <input <?php if($k1==0) echo 'checked="checked"' ;?> type="radio" name="color" value="<?php echo $v1['attr_value'];?>"  /></a>
