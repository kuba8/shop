				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath . $info['big_logo'];?>',largeimage: '<?php echo $viewPath . $info['mbig_logo'];?>'}"><img src="<?php echo $viewPath . $info['sm_logo'];?>"></a>
								</li>
							...
							<li class="product">
								<dl>
									...
									<?php foreach($v as $k1 => $v1):?>
										<a <?php if($k1==0) echo 'class="selected"' ;?>  href="javascript:;"><?php echo $v1['attr_value'];?> <input <?php if($k1==0) echo 'checked="checked"' ;?> type="radio" name="goods_attr_id[<?php echo $v1['attr_id'];?>]" value="<?php echo $v1['id'];?>"  /></a>
